...
//get referral code
  ...
  getUrls() async {
    ...
    androidPackage = 'com.elemamdev.mwaslat.masr.driver';
                                      ...
                                      await Share.share(
                                        ...
                                        languages[choosenLanguage]
                                            ...
                                            languages[choosenLanguage]
                                                ['text_invitation_2'] +
                                            ' \n\nPlay Store\n\n' +
                                            'https://play.google.com/store/apps/details?id=com.elemamdev.mwaslat.masr.driver' +
                                            '\n\nAppStore\n\n' +
                                            'https://apps.apple.com/eg/app/mwaslat-driver/id6448995747',
                                      );
                                    },
