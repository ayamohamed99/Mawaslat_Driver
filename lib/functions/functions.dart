...
//base url
String url = 'https://mwaslat.app/public/';
String mapkey = 'AIzaSyBQJfk03ru2q_cDbZjUQLHH7Prhk12WFkY';
String mapStyle = '';
...
registerDriver() async {
  ...
  try {
    ...
    dev.log('sss: ${response.fields}');
    var request = await response.send();
    var respon = await http.Response.fromStream(request);

    dev.log('sss: ${respon.body}');
    ...
    if (request.statusCode == 200) {
      ...
      FirebaseAnalytics.instance.setUserId(id: 'phnumber');
...
geolocs.LocationSettings locationSettings = (platform == TargetPlatform.android)
    ? geolocs.AndroidSettings(
        ...
        foregroundNotificationConfig:
          ...
          notificationText:
              "Mwaslat Driver will continue to receive your location in background",
